...
> 
> [我的的博客](http://Andy-bioin.github.io)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[YAOJ Blog](https://Andy-bioin.github.io)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。【这份博客是博客的原作者留下的，因为在git操作中，如果将原左右所有博客全部删除的话，就无法显示_posts这个文件了，所以我留下了它，如果有后来的小朋友看到的这份博客，也可以直接通过它来学习】
